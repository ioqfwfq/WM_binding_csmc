function c = set_parameters_t(c)
%% General experimental settings
% Marker values
c.marker.expstart        = 61;
c.marker.expend          = 60;
c.marker.fixOnset        = 11;
c.marker.pic1            = 1;
c.marker.delay1          = 2;
c.marker.pic2            = 3;
c.marker.delay2          = 4;
...
% stimili size
c.stimSizeW = 335; % horizontal pixels
c.stimSizeH  = c.stimSizeW/1.5; % vertical pixels
